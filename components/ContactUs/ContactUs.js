...
const ContactUs = () => {
    return (
        <div className={`bg-black p-4 py-16 ${styles.container}`}>
            <div className='bg-black/70 grid gap-5 grid-cols-1 md:grid-cols-2 grid gap-5 grid-cols-1 md:grid-cols-2 '>
                <div>
                    <h1 className="text-white text-[3rem] font-bold">We Are <span className="primaryText">Perfect Solutions</span> For <span className="primaryText">Your Business</span></h1>
