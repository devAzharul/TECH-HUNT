    ...
    <div className="flex justify-between items-center flex-wrap md:flex-nowrap px-8  py-20 bg-black/70">
        ...
        <div className="mb-10">
          <Slider {...settings}>
            {logoup.map((logo, index) => (
              <div key={index}>
                <Image className="w-[170px]" alt="logo" src={logo} />
              </div>
            ))}
          </Slider>
        </div>
      ...
      <div className="w-full md:w-1/3">
        <div className="mb-8 text-white font-bold">
          ...
          <h2>
            <span className="text-cyan-300 text-[2rem] md:text-[5remm]">
              {" "}
              IT Companies.
            </span>
          </h2>
        ...
        <div>
          <p className="text-white">
            Our dedication to serving you remains unwavering. As industry
            frontrunners, we prioritize your confidence, consistently delivering
            exceptional services and solutions tailored to your needs.
          </p>
        </div>
      </div>
    </div>
